...
# Adicione este código ANTES da linha "# Layout com Chat no Topo"
# Por exemplo, logo após o check_api_health()

# BOTÃO TEMPORÁRIO PARA TREINAR MODELO
st.markdown("---")
